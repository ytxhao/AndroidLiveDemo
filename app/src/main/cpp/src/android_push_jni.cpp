#include "com_ytx_live_jni_PushNative.h"

#include <android/log.h>
#include <android/native_window_jni.h>
#include <android/native_window.h>
#define LOGI(FORMAT,...) __android_log_print(ANDROID_LOG_INFO,"demo",FORMAT,##__VA_ARGS__)
...
JNIEXPORT void JNICALL Java_com_ytx_live_jni_PushNative_startPush
...
//	jcls_push_native = env->NewGlobalRef(jcls_push_native_tmp);
...
JNIEXPORT void JNICALL Java_com_ytx_live_jni_PushNative_stopPush
  (JNIEnv *env, jobject jobj){
	is_pushing = FALSE;
}


JNIEXPORT void JNICALL Java_com_ytx_live_jni_PushNative_release
  (JNIEnv *env, jobject jobj){
	//env->DeleteGlobalRef(jcls_push_native);
	env->DeleteGlobalRef(jobj_push_native);
	//env->DeleteGlobalRef(jmid_throw_native_error);
}

/**
 * 设置视频参数
 */
JNIEXPORT void JNICALL Java_com_ytx_live_jni_PushNative_setVideoOptions
 ...
 * 音频编码器配置
 */
JNIEXPORT void JNICALL Java_com_ytx_live_jni_PushNative_setAudioOptions
 ...
 * 将采集到视频数据进行编码
 */
JNIEXPORT void JNICALL Java_com_ytx_live_jni_PushNative_fireVideo
 ...
 * 对音频采样数据进行AAC编码
 */
JNIEXPORT void JNICALL Java_com_ytx_live_jni_PushNative_fireAudio
